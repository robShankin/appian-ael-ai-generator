...
class FunctionFilter {
  constructor() {
    this.MAX_FUNCTIONS = 15; // Limit functions to control token usage
  }

  /**
   * Find functions relevant to the user's request
   */
  findRelevantFunctions(userRequest, reference) {
  ...
  extractKeywords(text) {
    ...
    const stopWords = new Set([
      'the', 'a', 'an', 'and', 'or', 'but', 'in', 'on', 'at', 'to', 'for', 'of', 'with', 'from', 'by', 'as', 'is', 'was', 'are', 'been', 'be', 'have', 'has', 'had', 'do', 'does', 'did', 'will', 'would', 'could', 'should', 'may', 'might', 'must', 'can', 'this', 'that', 'these', 'those', 'i', 'you', 'he', 'she', 'it', 'we', 'they', 'want', 'need', 'create', 'make', 'get', 'use', 'using',
    ]);
   ...
   */
  calculateRelevanceScore(func, keywords, fullRequest) {
    let score = 0;
